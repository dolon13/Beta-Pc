				            ...
				            <div class="sidebar-widget widget-tasks">
				                ...
				                <div class="widget-content">
				                    <ul class="list-unstyled m-0">
				                        <li ><a href="<?php echo $baseurl; ?>add">Dashboard</a></li>
				...
				<hr class="dotted short">
				            <div class="sidebar-widget widget-tasks">
				                ...
				                <div class="widget-content">
									...
									<li ><a href="<?php echo $baseurl; ?>add/cpu">Processor</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/mboard">Motherboard</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/ram">RAM</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/gpu">Graphics Card</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/psu">Power Supply</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/ssd">SSD</a></li>
				                        <li><a href="<?php echo $baseurl; ?>add/hdd">HDD</a></li>
										<li><a href="<?php echo $baseurl; ?>add/casing">Casing</a></li>
				                    </ul>
				                </div>
				            </div>
				<hr class="dotted short">
